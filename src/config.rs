...
/*  modifier       key            modes          action   */
    ...
    bind(CTRL      , Char('h')   , &[NORMAL, VISUAL, VISUAL_LINE]         , Action::Focus(Direction::Left) ),
    bind(CTRL      , Char('j')   , &[NORMAL, VISUAL, VISUAL_LINE]         , Action::Focus(Direction::Down) ),
    bind(CTRL      , Char('l')   , &[NORMAL, VISUAL, VISUAL_LINE]         , Action::Focus(Direction::Right)),
    bind(CTRL      , Char('k')   , &[NORMAL, VISUAL, VISUAL_LINE]         , Action::Focus(Direction::Up)   ),
