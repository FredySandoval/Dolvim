...
/* vim-devicons file-extension overrides; extension without the leading `*.` */
pub const FILE_ICONS: &[(&str, &str)] = &[
    /* extension       glyph */
    ("styl"         , ""),
    ("sass"         , ""),
    ("scss"         , ""),
...
pub const NAV_BUTTONS  : &[Action] = &[Action::Back       , Action::Forward    , Action::OpenViewMenu];
pub const RIGHT_BUTTONS: &[Action] = &[Action::ToggleSplit, Action::EnterSearch, Action::OpenMenu    ];
